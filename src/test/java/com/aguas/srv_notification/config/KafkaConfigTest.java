...
public class KafkaConfigTest {
    ...
    void testProducerFactory() {
        ProducerFactory<String, PressureReading> factory = kafkaConfig.producerFactory();
    ...
    void testKafkaTemplate() {
        KafkaTemplate<String, PressureReading> template = kafkaConfig.kafkaTemplate();
    ...
    void testConsumerFactory() {
        ...
        assertEquals(PressureReading.class, configs.get(JsonDeserializer.VALUE_DEFAULT_TYPE));
